...
const filmeData = [{ src: 'image/the-lord-of-the-rings.png', alt: 'The Lord of the Rings', title: 'O Senhor dos Anéis' },
          { src: 'image/deadpool-and-wolverine.png', alt: 'Deadpool & Wolverine', title: 'Deadpool & Wolverine' },
          { src: 'image/The Chronicles Of Narnia - Prince Caspian 1.png', alt: 'Narnia: Prince Caspian', title: 'Narnia: Príncipe Caspian' },
          { src: 'image/flow.png', alt: 'Flow', title: 'Flow' },
          { src: 'image/alice-in-wonderland.png', alt: 'Alice in Wonderland', title: 'Alice no País das Maravilhas' },
